...
public class SignatureGenerator {
	...
	protected com.ooyala.sample.utils.crypto.IKeyInfo mSignatureKey = null;
	...
	public String generateSignature(String inData) throws AccessEnablerException {
		try {
			Signature rsaSigner = Signature.getInstance(com.ooyala.sample.utils.crypto.CryptoHelper.getSignatureAlgorithm());
			...
			return com.ooyala.sample.utils.crypto.CryptoHelper.base64Encode(signature);
		}
		catch(Exception e) {
