...
public class OoyalaSkinOPTPlayerActivity extends AbstractHookActivity implements EmbedTokenGenerator {
  ...
  void completePlayerSetup(boolean asked) {
    if(asked) {
      ...
      Environment.AUTHORIZE_HOST = "https://player.ooyala.com";
      Environment.METADATA_HOST = "https://player.ooyala.com";
      Environment.CONTENT_TREE_HOST = "https://player.ooyala.com";
      Environment.BACKLOT_HOST = "https://player.ooyala.com";
      Environment.DRM_HOST = "https://player.ooyala.com";
...
//     params.put("override_syndication_group", "override_all_synd_groups");
    ...
    EmbeddedSecureURLGenerator urlGen = new EmbeddedSecureURLGenerator("F5bGsyOovEON1FJUjhscLRgo3j4a.0ipZk", "ofC7VlnRPNtI7tiOLb5AmOhWrn3KSh_XfdJSInHY");

    URL tokenUrl = urlGen.secureURL("https://player.ooyala.com", uri, params);
