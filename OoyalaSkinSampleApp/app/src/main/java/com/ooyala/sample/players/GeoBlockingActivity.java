...
public class GeoBlockingActivity extends AbstractHookActivity implements EmbedTokenGenerator {
  private final String ACCOUNT_ID = "110698";

  /*
   * The API Key and Secret should not be saved inside your applciation (even in git!).
   * However, for debugging you can use them to locally generate Ooyala Player Tokens.
   */
  private final String APIKEY = "BzY2syOq6kIK6PTXN7mmrGVSJEFj.APkQ3";
  private final String SECRET = "nYDE1TkyZOhyQ2HZBRjCZ1E0tCNFvgk8b2UmvHd1";
