...
public class AdvancedPlaybackListActivity extends Activity implements OnItemClickListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    selectionMap.put(PluginPlayerActivity.getName(), new PlayerSelectionOption("lrZmRiMzrr8cP77PPW0W8AsjjhMJ1BBe", "c0cTkxOqALQviQIGAHWY5hP0q9gU", "http://www.ooyala.com", PluginPlayerActivity.class));
