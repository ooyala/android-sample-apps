...
public class SampleChooserActivity extends Activity {
  ...
  private final class SampleListLoader extends AsyncTask<String, Void, List<SampleGroup>> {
    ...
    private Sample readEntry(JsonReader reader, boolean insidePlaylist) throws IOException {
      ...
      boolean downloaderSample = false;
      boolean offlineSample = false;
      ...
      while (reader.hasNext()) {
        ...
        switch (name) {
          ...
          case "ad_tag_uri":
            ...
            break;
          case "downloader":
            downloaderSample = reader.nextBoolean();
            break;
          case "offline":
            offlineSample = reader.nextBoolean();
            break;
          default:
  ...
  private static final class DrmInfo {
    ...
    public void updateIntent(Intent intent) {
      ...
      intent.putExtra(Constants.DRM_SCHEME_EXTRA, drmSchemeUuid.toString());
      intent.putExtra(Constants.DRM_LICENSE_URL, drmLicenseUrl);
      intent.putExtra(Constants.DRM_KEY_REQUEST_PROPERTIES, drmKeyRequestProperties);
      intent.putExtra(Constants.DRM_MULTI_SESSION, drmMultiSession);
    }
  }
  ...
  private abstract static class Sample {
    ...
    public void updateDrmInfo(Intent intent) {
      if (drmInfo != null) {
        drmInfo.updateIntent(intent);
      }
    }

    abstract Intent buildIntent(Context context);

  }

  private static final class DownloaderSample extends UriSample {

    public DownloaderSample(String name, boolean preferExtensionDecoders, DrmInfo drmInfo, String uri,
  ...
  private static class UriSample extends Sample {
    ...
    public void setExtraData(Intent intent) {
      intent
        ...
        .putExtra(Constants.PREFER_EXTENSION_DECODERS, preferExtensionDecoders)
        .putExtra(Constants.EXTENSION_EXTRA, extension)
        .putExtra(Constants.AD_TAG_URI_EXTRA, adTagUri)
        .setAction(Constants.ACTION_VIEW);
    }
  }
  ...
  private static final class PlaylistSample extends Sample {
    ...
    public Intent buildIntent(Context context) {
      ...
      intent
        .putExtra(Constants.PREFER_EXTENSION_DECODERS, preferExtensionDecoders)
        .putExtra(Constants.URI_LIST_EXTRA, uris)
        .putExtra(Constants.EXTENSION_LIST_EXTRA, extensions)
        .setAction(Constants.ACTION_VIEW_LIST);
